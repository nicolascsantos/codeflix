...
namespace FC.CodeFlix.Catalog.UnitTests.Application.Genre.ListGenres
{
    ...
    public class ListGenresTest
    {
        ...
        public async Task ListGenres()
        {
            ...
            var input = _fixture.GetListGenresExampleInput();
            ...
            {
                var genreRepository = outputRepositorySearch.Items
                    .FirstOrDefault(x => x.Id == outputItem.Id);
                outputItem.Should().NotBeNull();
                outputItem.Name.Should().Be(genreRepository!.Name);
                outputItem.IsActive.Should().Be(genreRepository.IsActive);
                outputItem.Id.Should().Be(genreRepository.Id);
                outputItem.CreatedAt.Should().Be(genreRepository.CreatedAt);
                outputItem.Categories.Should().HaveCount(genreRepository.Categories.Count);
            });
            ...
            var expectedIds = exampleGenresList
